...
```bash
# Run container
docker run -d -p 3000:3001 --name thecliff-app thecliff-app:latest

# Run with environment file
docker run -d -p 3000:3001 --env-file .env.production --name thecliff-app thecliff-app:latest
...
# Run from registry
docker run -d -p 3000:3001 ghcr.io/thecliffresort/thecliff-app:latest
```
